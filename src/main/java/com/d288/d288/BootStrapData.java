...
public class BootStrapData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        if (customerRepository.count() == 1) {
            ...
            cust1.setDivision(divisionRepository.getReferenceById(6L));
            ...
            cust2.setDivision(divisionRepository.getReferenceById(2L));
            ...
            cust3.setDivision(divisionRepository.getReferenceById(3L));
            ...
            cust4.setPhone("738274987");
            cust4.setPostal_code("473922");
            cust4.setDivision(divisionRepository.getReferenceById(4L));
            ...
            cust5.setPhone("43279843");
            cust5.setPostal_code("782978");
            cust5.setDivision(divisionRepository.getReferenceById(5L));
